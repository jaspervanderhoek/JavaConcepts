 ...
 */
public class PrepareLogSubscriber extends CustomJavaAction<Boolean>
{
	private String LogEntityName;
	private Boolean StartSubscriber;

	public PrepareLogSubscriber(IContext context, String LogEntityName, Boolean StartSubscriber)
	{
		super(context);
