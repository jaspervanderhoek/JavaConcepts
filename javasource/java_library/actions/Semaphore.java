...
public class Semaphore extends CustomJavaAction<Boolean>
{
	...
	private Boolean TryUntilAvailable;
	private String ReferenceMessage;

	public Semaphore(IContext context, String Identifier, Boolean LockTheProcess, Boolean TryUntilAvailable, String ReferenceMessage)
	{
		super(context);
