...
public class GetFilesFromSFTP extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	private Boolean ftpRemoveAfterDownload;

	public GetFilesFromSFTP(IContext context, String ftpHostName, String ftpUserName, String ftpPassword, String ftpRemoteDirectory, Long ftpPort, Boolean ftpRemoveAfterDownload)
	{
		super(context);
