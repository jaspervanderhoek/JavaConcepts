 ...
 * 
 */
public class CreateZipFile extends CustomJavaAction<Boolean>
{
	...
	public CreateZipFile(IContext context, java.util.List<IMendixObject> ExportFileList, IMendixObject TargetZipDocument, String TargetFileName)
	{
		super(context);
